...
export const metadata: Metadata = {
  title: "What to Expect - Throwbacks Arcade",
...
export default function WhatToExpectPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-4xl mb-12 text-center neon-text-orange">What to Expect</h1>

      <div className="space-y-16">
        {/* Tickets Section */}
        <section className="space-y-4">
          <h2 className="text-2xl mb-4 neon-text-orange">Grab Your Ticket</h2>
          <p className="text-lg">
        ...
        {/* How to Play Section */}
        <section className="space-y-4">
          <h2 className="text-2xl mb-4 neon-text-orange">How to Play</h2>
          <p className="text-lg">
